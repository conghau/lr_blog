              ...
              <i class="fa fa-angle-left pull-right"></i>
                ...
                <ul class="treeview-menu">
                    <li class="active"><a href="index.html"><i
                                    class="fa fa-circle-o"></i> Dashboard v1</a>
                    </li>
              ...
              <span class="label label-primary pull-right">4</span>
                ...
                <ul class="treeview-menu">
                    ...
                    <li><a href="pages/layout/collapsed-sidebar.html"><i
                                    class="fa fa-circle-o"></i> Collapsed
                            Sidebar</a></li>
                </ul>
            </li>
            <li>
              ...
              <i class="fa fa-angle-left pull-right"></i>
                ...
                <ul class="treeview-menu">
                    ...
                    <li><a href="pages/forms/advanced.html"><i
                                    class="fa fa-circle-o"></i> Advanced
                            Elements</a></li>
              ...
              <i class="fa fa-angle-left pull-right"></i>
                ...
                <ul class="treeview-menu">
                    ...
                    <li><a href="pages/examples/pace.html"><i
                                    class="fa fa-circle-o"></i> Pace Page</a>
                    </li>
                </ul>
            </li>
            <li class="treeview">
